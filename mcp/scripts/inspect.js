...
const serverPath = resolve(projectRoot, 'dist/stdio.js')

// Check if stdio.js exists, if not, build it
...
function startInspector() {
  const absolutePath = resolve(projectRoot, 'dist/stdio.js')
  ...
  // Start the inspector
  const inspectorProcess = spawn('npx', ['-y', '@modelcontextprotocol/inspector'], {
    cwd: projectRoot,
    stdio: 'inherit',
  })
