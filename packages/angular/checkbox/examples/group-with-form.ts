...
@Component({
  selector: 'checkbox-group-with-form-example',
  standalone: true,
  ...
  template: `
    <form class="vstack" (submit)="onSubmit($event)">
      ...
      <button class="checkbox-demo-button" type="submit">Submit</button>
    </form>
  `,
  styles: [checkboxExampleStyles],
})
export class CheckboxGroupWithFormExample {
