...
@Component({
  selector: 'tags-input-disabled-example',
  standalone: true,
  ...
  template: `
    <div arkTagsInputRoot #root="arkTagsInputRoot" [defaultValue]="['React', 'Solid', 'Vue']" disabled>
...
export class TagsInputDisabledExample {}
