...
@Component({
  selector: 'tags-input-max-with-overflow-example',
  standalone: true,
  ...
  template: `
    <div arkTagsInputRoot #root="arkTagsInputRoot" [max]="3" allowOverflow>
...
export class TagsInputMaxWithOverflowExample {}
