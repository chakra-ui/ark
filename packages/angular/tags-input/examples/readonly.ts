...
@Component({
  selector: 'tags-input-readonly-example',
  standalone: true,
  ...
  template: `
    <div arkTagsInputRoot #root="arkTagsInputRoot" [defaultValue]="['React', 'Solid', 'Vue']" readOnly>
...
export class TagsInputReadonlyExample {}
