...
@Component({
  selector: 'angle-slider-step-example',
  standalone: true,
  ...
  template: `
    <div arkAngleSlider [step]="15" #angleSlider="arkAngleSlider">
      <label arkAngleSliderLabel>15 Step</label>
...
export class AngleSliderStepExample {
