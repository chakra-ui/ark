...
import { childIndexPath, disabledFileTreeCollection } from './_tree-data'

@Component({
  selector: 'tree-view-disabled-node-example',
  standalone: true,
...
export class TreeViewDisabledNodeExample {
  readonly collection = disabledFileTreeCollection
