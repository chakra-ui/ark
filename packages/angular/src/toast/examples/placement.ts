...
@Component({
  ...
  template: `
    <div class="toast-demo">
      <button type="button" class="toast-button" (click)="show()">Show top toast</button>
    </div>
...
export class ToastPlacementExample {
  readonly toaster = createToaster({ placement: 'top-end' })

  show(): void {
    this.toaster.create({
      title: 'Top right',
      description: 'This toast is rendered near the top edge.',
    })
  }
}
