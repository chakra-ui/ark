...
@Component({
  selector: 'date-input-granularity-example',
  standalone: true,
  ...
  template: `
    <div arkDateInput granularity="second">
      <label arkDateInputLabel>Date & Time</label>
...
export class DateInputGranularityExample {}
