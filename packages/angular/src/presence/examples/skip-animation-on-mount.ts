...
@Component({
  selector: 'presence-skip-animation-on-mount-example',
  standalone: true,
  ...
  template: `
    <div class="root">
      ...
      <ark-presence [present]="present()" skipAnimationOnMount>
        <ng-template>
          <div class="panel">Initial mount skips the open animation state.</div>
        </ng-template>
      </ark-presence>
    </div>
  `,
...
export class PresenceSkipAnimationOnMountExample {
