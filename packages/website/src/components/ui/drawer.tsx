...
import { drawer, type DrawerVariantProps } from '@ark-ui/styled-system/recipes'
...
export const DrawerContainer = withContext(styled(Ark.Dialog.Positioner), 'container')
