...
|------------------|----------------------------|--------------------------------------|---------------|
| data-scope       | 'tabs'                     | Indicates the scope of this part     | -             |
| data-part        | 'root'                     | Indicates which part is this element | -             |
| data-orientation | 'horizontal' \| 'vertical' | Reflects the orientation of the tabs | -             |
...
|------------------|----------------------------|--------------------------------------|---------------|
| data-scope       | 'tabs'                     | Indicates the scope of this part     | -             |
| data-part        | 'list'                     | Indicates which part is this element | -             |
| data-orientation | 'horizontal' \| 'vertical' | Reflects the orientation of the tab  | -             |
...
| data-orientation | 'horizontal' \| 'vertical' | Reflects the orientation of the tab        | -             |
| data-value       | string                     | The value associated with the tab trigger  | -             |
| data-ownedby     | string                     | Indicates the id of the owner element      | -             |
| data-selected    | boolean                    | Indicates if the tab is currently selected | -             |
...
| data-orientation | 'horizontal' \| 'vertical' | Reflects the orientation of the tab            | -             |
| data-state       | 'open' \| 'closed'         | Indicates the current state of the tab content | -             |
| data-ownedby     | string                     | Indicates the id of the owner element          | -             |
