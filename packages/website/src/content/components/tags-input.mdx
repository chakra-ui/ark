...
|------------|--------------|--------------------------------------|---------------|
| data-scope | 'tags-input' | Indicates the scope of this part     | -             |
...
| data-value | string       | The value of the tag                 | -             |
...
| data-value | string         | The value of the tag preview         | -             |
...
|------------|--------------|--------------------------------------|---------------|
| data-scope | 'tags-input' | Indicates the scope of this part     | -             |
| data-part  | 'item-input' | Indicates which part is this element | -             |
...
|------------|-----------------|--------------------------------------|---------------|
| data-scope | 'tags-input'    | Indicates the scope of this part     | -             |
| data-part  | 'clear-trigger' | Indicates which part is this element | -             |
