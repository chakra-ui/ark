...
The PinInput component consists of the `PinInput.Control` `PinInput.Input` and
`PinInput.Label` components. Combine them as desired to fit your design system.
