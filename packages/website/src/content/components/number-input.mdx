...
The NumberInput component consists of the `Number.InputLabel`,
`Number.InputControl`, `Number.InputInput`, `Number.InputDecrementTrigger`,
`Number.InputIncrementTrigger`, `Number.InputScrubber`, components.
