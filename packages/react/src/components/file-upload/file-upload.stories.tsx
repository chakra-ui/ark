...
export { Dropzone } from './examples/dropzone'
...
export { MediaCapture } from './examples/media-capture'
export { PastingFiles } from './examples/pasting-files'
export { RejectedFiles } from './examples/rejected-files'
export { RootProvider } from './examples/root-provider'
export { TransformFiles } from './examples/transform-files'
