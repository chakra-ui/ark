...
export interface FloatingPanelStageTriggerBaseProps
  extends PolymorphicProps<FloatingPanelStageTriggerState>, StageTriggerProps {}
...
export const FloatingPanelStageTrigger = forwardRef<HTMLButtonElement, FloatingPanelStageTriggerProps>((props, ref) => {
  ...
  return <ark.button {...mergedProps} ref={ref} state={floatingPanel.getStageTriggerState(stage)} />
})
