import { Sizer, type SizerResizeDetails } from '@ark-ui/react/sizer'
import { useState } from 'react'

export const Callback = () => {
  const [items, setItems] = useState(['Item 1', 'Item 2', 'Item 3'])
  const [dimensions, setDimensions] = useState<SizerResizeDetails>({ width: 0, height: 0 })
  ...
  return (
    <div>
      <div className="sizer-controls-with-info">
        ...
        <div className="sizer-dimensions">
