...
export interface NumberInputIncrementTriggerBaseProps extends PolymorphicProps<NumberInputIncrementTriggerState> {}
...
export const NumberInputIncrementTrigger = forwardRef<HTMLButtonElement, NumberInputIncrementTriggerProps>(
  (props, ref) => {
    ...
    return <ark.button {...mergedProps} ref={ref} state={numberInput.getIncrementTriggerState()} />
  },
)
