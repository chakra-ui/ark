...
const TocTreeNode = ({ node, indexPath }: TreeView.NodeProviderProps<TocNode>) => {
  ...
  return (
    <TreeView.NodeProvider node={node} indexPath={indexPath}>
      {node.children ? (
        <TreeView.NodeGroup className={treeStyles.NodeGroup}>
          <TreeView.Node className={treeStyles.Node}>
            <TreeView.Cell className={treeStyles.Cell}>
              <TreeView.NodeExpandTrigger className={treeStyles.NodeExpandTrigger}>
                <TreeView.NodeIndicator type="expanded" className={treeStyles.NodeIndicator}>
                  <ChevronRightIcon />
          ...
          <TreeView.NodeGroupContent className={treeStyles.NodeGroupContent}>
            <TreeView.IndentGuide className={treeStyles.IndentGuide} />
