...
export const Multiple = () => (
  <CascadeSelect.Root className={styles.Root} collection={collection} multiple>
    <CascadeSelect.Label className={styles.Label}>Locations</CascadeSelect.Label>
    <CascadeSelect.Control className={styles.Control}>
      <CascadeSelect.Trigger className={styles.Trigger}>
        <CascadeSelect.ValueText className={styles.ValueText} placeholder="Select locations" />
