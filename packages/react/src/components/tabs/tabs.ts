...
} from './tab-indicator.tsx'
export { TabList as List, type TabListBaseProps as ListBaseProps, type TabListProps as ListProps } from './tab-list.tsx'
export {
