...
export interface HoverCardContentBaseProps extends PolymorphicProps<HoverCardContentState> {}
...
export const HoverCardContent = forwardRef<HTMLDivElement, HoverCardContentProps>((props, ref) => {
  ...
  return (
    <PresenceGate presence={presence}>
      <ark.div {...mergedProps} ref={composedRefs} state={hoverCard.getContentState()} />
    </PresenceGate>
  )
})
