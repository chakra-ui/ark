...
export const ComponentUnderTest = (props: TreeViewRootProps) => {
  return (
    <TreeView.Root {...props}>
      ...
      <TreeView.Tree>
        <TreeView.BranchTrigger id="node_modules" depth={1}>
          Toggle
        ...
        <TreeView.Branch id="node_modules" depth={1}>
          ...
          <TreeView.BranchIndicator id="node_modules" depth={1}>
            node_modules Branch Indicator
          ...
          <TreeView.BranchContent id="node_modules" depth={1}>
            ...
            <TreeView.ItemText id="node_modules/pandacss" depth={2}>
              Panda ItemText
            </TreeView.ItemText>
