...
In some cases, you might need to use custom controls to toggle the edit and read mode. We use `ref` prop from `Editable` to provide access to the internal state of the component.
