...
export { default as Content, type SelectContentProps as ContentProps } from './select-content.vue'
...
export { default as Item, type SelectItemProps as ItemProps } from './select-item.vue'
export { default as Label, type SelectLabelProps as LabelProps } from './select-label.vue'
export {
...
export { default as Trigger, type SelectTriggerProps as TriggerProps } from './select-trigger.vue'
export {
