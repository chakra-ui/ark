...
} from './steps-separator.vue'
export {
  default as Trigger,
  type StepsTriggerBaseProps as TriggerBaseProps,
  type StepsTriggerProps as TriggerProps,
} from './steps-trigger.vue'
export { default as ItemContext, type StepsItemContextProps as ItemContextProps } from './steps-item-context.vue'
