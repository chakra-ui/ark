...
export { default as StepsContent, type StepsContentBaseProps, type StepsContentProps } from './steps-content.vue'
...
export { default as StepsProgress, type StepsProgressBaseProps, type StepsProgressProps } from './steps-progress.vue'
export {
  default as StepsRootProvider,
  type StepsRootProviderBaseProps,
  type StepsRootProviderProps,
} from './steps-root-provider.vue'
export { default as StepsRoot, type StepsRootBaseProps, type StepsRootProps } from './steps-root.vue'
export {
  default as StepsSeparator,
  type StepsSeparatorBaseProps,
  type StepsSeparatorProps,
} from './steps-separator.vue'
export { default as StepsTrigger, type StepsTriggerBaseProps, type StepsTriggerProps } from './steps-trigger.vue'
