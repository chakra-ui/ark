...
import { Sizer, type SizerResizeDetails } from '@ark-ui/vue/sizer'
import { ref } from 'vue'

const items = ref(['Item 1', 'Item 2', 'Item 3'])
const dimensions = ref<SizerResizeDetails>({ width: 0, height: 0 })
