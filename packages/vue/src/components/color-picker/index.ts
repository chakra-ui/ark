...
export { default as ColorPickerArea, type ColorPickerAreaProps } from './color-picker-area.vue'
export {
...
export { default as ColorPickerLabel, type ColorPickerLabelProps } from './color-picker-label.vue'
export {
