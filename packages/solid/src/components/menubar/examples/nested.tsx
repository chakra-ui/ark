      ...
      <Portal>
        <Menu.Positioner>
          <Menu.Content class={menu.Content}>
            ...
            <Menu.Root>
              <Menu.TriggerItem class={menu.TriggerItem}>Export</Menu.TriggerItem>
              <Portal>
                <Menu.Positioner>
                  <Menu.Content class={menu.Content}>
                    <Menu.Item class={menu.Item} value="pdf">
                      PDF
                    </Menu.Item>
                    <Menu.Item class={menu.Item} value="png">
                      PNG
                    </Menu.Item>
                    <Menu.Item class={menu.Item} value="svg">
                      SVG
                    </Menu.Item>
                  </Menu.Content>
                </Menu.Positioner>
            ...
            <Menu.Separator class={menu.Separator} />
            <Menu.Item class={menu.Item} value="print">
              Print...
            </Menu.Item>
          </Menu.Content>
        </Menu.Positioner>
      ...
      <Portal>
        <Menu.Positioner>
          <Menu.Content class={menu.Content}>
            ...
            <Menu.Separator class={menu.Separator} />
            <Menu.Root>
              <Menu.TriggerItem class={menu.TriggerItem}>Find</Menu.TriggerItem>
              <Portal>
                <Menu.Positioner>
                  <Menu.Content class={menu.Content}>
                    <Menu.Item class={menu.Item} value="find">
                      Find...
                    </Menu.Item>
                    <Menu.Item class={menu.Item} value="find-next">
                      Find Next
                    </Menu.Item>
                    <Menu.Item class={menu.Item} value="replace">
                      Replace...
                    </Menu.Item>
                  </Menu.Content>
                </Menu.Positioner>
