...
export interface FloatingPanelResizeTriggerBaseProps
  extends ResizeTriggerProps, PolymorphicProps<'div', FloatingPanelResizeTriggerState> {}
...
export const FloatingPanelResizeTrigger = (props: FloatingPanelResizeTriggerProps) => {
  ...
  return <ark.div {...mergedProps} state={floatingPanel().getResizeTriggerState(resizeProps)} />
}
