...
export interface WindowVirtualizerItemBaseProps extends ItemProps, PolymorphicProps<'div'> {}
export interface WindowVirtualizerItemProps extends Assign<HTMLProps<'div'>, WindowVirtualizerItemBaseProps> {}

const splitItemProps = createSplitProps<ItemProps>()

export const WindowVirtualizerItem = (props: WindowVirtualizerItemProps) => {
