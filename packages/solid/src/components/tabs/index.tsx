...
export { TabContent, type TabContentBaseProps, type TabContentProps, type TabContentState } from './tab-content.tsx'
...
export { TabTrigger, type TabTriggerBaseProps, type TabTriggerProps, type TabTriggerState } from './tab-trigger.tsx'
