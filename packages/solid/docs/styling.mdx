...
```tsx
<Tabs>
  <TabList class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200">
    <TabTrigger
      value="solid"
...
<Tabs data-scope="tabs" data-part="root">
  <TabList data-scope="tabs" data-part="tablist">
    <TabTrigger data-scope="tabs" data-part="trigger" value="solid">
      Solid
    </TabTrigger>
  </TabList>
</Tabs>
...
<Tabs>
  <TabList asChild>
    <List>
      <TabTrigger value="solid" asChild>
        <Button>Solid</Button>
      </TabTrigger>
    </List>
  </TabList>
