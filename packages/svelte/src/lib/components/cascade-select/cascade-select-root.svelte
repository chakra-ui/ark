<script module lang="ts">
  ...
  export interface CascadeSelectRootBaseProps<T extends CascadeSelectNode = CascadeSelectNode>
    extends UseCascadeSelectProps<T>, UsePresenceProps, PolymorphicProps<'div'>, RefAttribute {}
  export interface CascadeSelectRootProps<T extends CascadeSelectNode = CascadeSelectNode> extends Assign<
    HTMLProps<'div'>,
...
<script lang="ts" generics="T extends CascadeSelectNode = CascadeSelectNode">
  ...
  import {
    ...
    splitPresenceProps,
    usePresence,
    type UsePresenceProps as _UsePresenceProps,
  } from '../presence'
