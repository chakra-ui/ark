<script module lang="ts">
  ...
  export interface ColorPickerTransparencyGridBaseProps extends TransparencyGridProps, PolymorphicProps<'div'>, RefAttribute {}
...
<script lang="ts">
  ...
  let { ref = $bindable(), ...props }: ColorPickerTransparencyGridProps = $props()
