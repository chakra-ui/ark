...
<div>
  <div class={styles.Controls}>
    <button type="button" class={styles.Trigger} onclick={() => virtualizer.scrollToIndex(0)}>Scroll to top</button>
    <button
      type="button"
    ...
    <button type="button" class={styles.Trigger} onclick={() => virtualizer.scrollToIndex(items.length - 1)}>
      Scroll to bottom
    </button>
  </div>
