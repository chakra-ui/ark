...
Please note that the examples in this section are for SFCs as this is the
recommended way to write Vue components. For JSX/TSX approach, you can refer to
Solid's documentation as it is the same in JSX/TSX for Vue.
...
<template>
  <tabs>
    <tab-list :style="tabListStyles">
      <tab-trigger value="vue" :style="tabTriggerStyles"> Vue </tab-trigger>
    </tab-list>
  </tabs>
</template>
```
...
Instead of styling your component using the selectors, you can directly target
your element with CSS modules. This will help you style your component while
avoiding collision with other classes.

```vue
<template>
  <tabs>
    <tab-list :class="tabs.list">
      <tab-trigger :class="tabs.trigger" value="vue"> Vue </tab-trigger>
    </tab-list>
  </tabs>
</template>
