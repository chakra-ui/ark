...
export const ReactIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width="24" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const SolidIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width="24" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const VueIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width="24" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const SolidStartIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 190 162" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <mask id="mask1_1_11" maskUnits="userSpaceOnUse" x="27" y="86" width="103" height="53">
      <path
        d="M50.6 86C42.6 86.4 27.8 87.8 27.8 87.8L92.3 134.7L107 138.4L129.3 136.7L64.4 89.7C64.4 89.7 59.2 86 51.7 86C51.3 86 51 86 50.6 86Z"
        fill="white"
      />
    </mask>
    ...
    <mask id="mask3_1_11" maskUnits="userSpaceOnUse" x="71" y="12" width="106" height="55">
      <path
        d="M94.6 12.7C86.3 13 71.1 14.2 71.1 14.2L138.3 62.2L153.5 66.1L176.5 64.7L108.9 16.6C108.9 16.6 103.3 12.7 95.4 12.7C95.2 12.7 94.9 12.7 94.6 12.7Z"
        fill="white"
      />
    </mask>
    ...
    <mask id="mask4_1_11" maskUnits="userSpaceOnUse" x="11" y="87" width="96" height="63">
      <path
        d="M11.8 98.2C11.7 98.3 11.7 98.4 11.7 98.5L29.4 111.3L46.9 124L76.3 145.3C86.2 152.4 99.6 149.4 106.4 138.4L88.5 125.5L70.6 112.6L41.5 91.4C37.9 88.8 33.9 87.6 29.9 87.6C22.9 87.6 16 91.3 11.8 98.2Z"
        fill="white"
      />
    </mask>
    ...
    <mask id="mask5_1_11" maskUnits="userSpaceOnUse" x="55" y="14" width="99" height="63">
      <path
        d="M55.4 24.5C55.4 24.6 55.3 24.7 55.2 24.8L73.6 37.9L92 50.9L122.6 72.7C132.9 80 146.7 77.1 153.5 66.2L134.9 52.9L116.3 39.7L85.9 18C82.1 15.3 77.8 14 73.6 14C66.5 14.1 59.6 17.7 55.4 24.5Z"
        fill="white"
      />
    </mask>
    ...
    <mask id="mask6_1_11" maskUnits="userSpaceOnUse" x="42" y="37" width="101" height="84">
      <path
        d="M42.4 39.3L66.1 65.3C67.2 66.8 68.4 68.2 69.8 69.4L116 120.2L139 118.8C145.8 107.9 143 93.1 132.7 85.8L102.1 64L83.8 51L65.4 37.9L42.4 39.3Z"
        fill="white"
      />
    </mask>
    ...
    <mask id="mask7_1_11" maskUnits="userSpaceOnUse" x="38" y="39" width="82" height="82">
      <path
        d="M42.2 39.6C35.5 50.4 38.3 65 48.4 72.2L78.7 93.8L97.4 107L116 120.2C122.8 109.3 120 94.5 109.7 87.2L79.2 65.5L60.8 52.4L42.4 39.3C42.4 39.4 42.3 39.5 42.2 39.6Z"
        fill="white"
      />
    </mask>
