...
const semanticTokens = defineSemanticTokens.colors({
  ...
  default: { value: { base: '{colors.red.light.9}', _dark: '{colors.red.dark.9}' } },
  emphasized: { value: { base: '{colors.red.light.10}', _dark: '{colors.red.dark.10}' } },
  fg: { value: { base: 'white', _dark: 'white' } },
  text: { value: { base: '{colors.red.light.a11}', _dark: '{colors.red.dark.a11}' } },
})
