...
const semanticTokens = defineSemanticTokens.colors({
  ...
  default: { value: { base: '{colors.sand.light.9}', _dark: '{colors.sand.dark.9}' } },
  emphasized: { value: { base: '{colors.sand.light.10}', _dark: '{colors.sand.dark.10}' } },
  fg: { value: { base: 'white', _dark: 'white' } },
  text: { value: { base: '{colors.sand.light.12}', _dark: '{colors.sand.dark.12}' } },
})
