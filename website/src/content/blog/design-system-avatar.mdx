...
tags: ['react', 'javascript', 'avatar', 'typescript', 'ark-ui', 'design-system'], 
---
...
To set up the avatar correctly, you'll need to understand its anatomy and how we name its parts. Each part includes
