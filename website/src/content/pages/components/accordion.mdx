...
Use the `useAccordionContext` hook to access the state of an accordion item. It exposes the following properties:
...
Use the `useAccordionItemContext` hook to access the state of an accordion item. It exposes the following properties:
