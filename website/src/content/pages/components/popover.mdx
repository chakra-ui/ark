...
The `RootProvider` component provides a context for the popover. It accepts the value of the
`usePopover` hook. You can leverage it to access the component state and methods from outside the
popover.
