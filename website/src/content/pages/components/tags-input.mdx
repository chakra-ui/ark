...
The `RootProvider` component provides a context for the tags-input. It accepts the value of the
`useTags-input` hook. You can leverage it to access the component state and methods from outside the
tags-input.
