...
For Angular projects, install `@ark-ui/angular` in an Angular 20+ application:

```bash
npm install @ark-ui/angular
# or
pnpm install @ark-ui/angular
# or
yarn add @ark-ui/angular
# or
bun add @ark-ui/angular
```

Ark UI for Angular ships standalone components, directives, and providers. Import the APIs you use directly in your
standalone component `imports` array, or register provider functions in your application config.
