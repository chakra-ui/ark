...
For Angular, import `ArkFormatByteComponent` from `@ark-ui/angular/format`.

```ts
import { ArkFormatByteComponent } from '@ark-ui/angular/format'
```
...
<Example component="format" id="byte-with-unit-system" />
