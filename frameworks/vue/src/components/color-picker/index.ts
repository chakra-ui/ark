...
import { type ColorPickerAreaContext, useColorPickerAreaContext } from './color-picker-area-context'
...
import { type ColorPickerContext, useColorPickerContext } from './color-picker-context'
